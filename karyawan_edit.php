						...
						<form class="form-horizontal" action="karyawan_update.php" method="POST" enctype="multipart/form-data">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Jadwal WFH</label>
										<div class="col-sm-3">
											<input type="text" name="wfh" class="form-control" placeholder="Jadwal WFH" value="<?php echo $data['wfh'] ?>"required>
										</div>
									</div>
									<div class="form-group">
