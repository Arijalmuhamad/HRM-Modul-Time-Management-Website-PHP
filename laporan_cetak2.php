<?php
	...
	$sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp
			AND lembur.tgl_pengajuan BETWEEN '$mulai' AND '$selesai'
			ORDER BY lembur.tgl_pengajuan DESC";
	$query = mysqli_query($conn,$sql);
	// deskripsi halaman
	$pagedesc = "Laporan Data lembur - Periode " . IndonesiaTgl($mulai) ." - ". IndonesiaTgl($selesai);
...
<body>
	...
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">LAPORAN DATA lembur</h4>
