					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND 
										cuti.stt_cuti='Menunggu Persetujuan HRD' ORDER BY cuti.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ';?>
													  <a href="approval_review.php?no=<?php echo $data['no_cuti'];?>" class="btn btn-primary btn-xs">Review</a>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
