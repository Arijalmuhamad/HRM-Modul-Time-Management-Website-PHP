							...
							<div class="panel-body">
								<table class="table table-striped table-bordered table-hover" id="tabel-data">
									...
									<tbody>
										<?php
											$i = 1;
											$sql = "SELECT DISTINCT npp,nama_emp,telp_emp,divisi,hak_akses FROM employee INNER JOIN data_absen USING(npp)order by npp ASC";
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												// echo '<td class="text-center"><a href="data_absensi_detail.php?npp='. $data['npp'] .'" class="btn btn-primary btn-xs">Lihat</a>';?>
												
												<td class="text-center">
													<a href="data_absensi_detail.php?npp=<?=$data['npp']?>" class="btn btn-primary btn-xs">
													<b>Detail</b></a>
												</td>
												<?php
													  echo '</td>';
