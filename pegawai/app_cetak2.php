<?php
	...
	$sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp
			AND lembur.no_lembur ='$no'";
	$query = mysqli_query($conn,$sql);
	$result = mysqli_fetch_array($query);
	// deskripsi halaman
	$pagedesc = "Cetak Form Lembur";
...
<br/>
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">FORM PENGAJUAN LEMBUR (DISETUJUI)</h4>
			<br />
			<br />
...
<h3>
				<tbody>
					<tr>
						<td width="30%">No. Lembur</td>
						<td><?php echo $result['no_lembur'];?></td>
					</tr>
					<tr>
						<td>NPP</td>
					...
					<tr>
						<td>Keterangan yang dikerjakan</td>
						<td><?php echo $result['keterangan'];?></td>
					</tr>
					<tr>
						<td>Status</td>
						<td><?php echo $result['stt_lembur'];?></td>
					</tr>
				</tbody>
				</h3>
			</table>
