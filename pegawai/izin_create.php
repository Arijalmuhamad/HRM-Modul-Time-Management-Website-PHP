					...
					<div class="col-lg-12">
						<form class="form-horizontal" name="izin" action="izin_insert.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">
							<div class="panel panel-default">
								<div class="panel-heading"><h3>Form Pengajuan Izin Dinas</h3></div>
								<div class="panel-body">
									<div class="form-group">
										<label class="control-label col-sm-3">Mulai Izin Dinas</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Akhir Dinas</label>
										<div class="col-sm-4">
