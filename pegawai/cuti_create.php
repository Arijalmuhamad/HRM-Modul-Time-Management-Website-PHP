							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Sisa Cuti Anda Saat ini</label>
										<div class="col-sm-4">
											<h4><b>
											<?php
												$npp = $sess_pegawaiid;

												$mySql = "SELECT * FROM employee WHERE hak_akses='Pegawai' AND active='Aktif' ORDER BY nama_emp";
												
												$myQry = mysqli_query($conn, $mySql);
												$leaderData = mysqli_fetch_array($myQry)

											?>
											<?php echo $leaderData['jml_cuti'];?>
											</b></h4>
										</div>
									</div>
									<div class="form-group">
