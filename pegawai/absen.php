...
echo 	"<tr>
        ...
        <td class='text-center'><button type='button' class='btn btn-warning' onclick=\"window.location.href='../pegawai/proses.php?absen=1';\" $disable_in>Absen Masuk</button></td>
        <td class='text-center'><button type='button' class='btn btn-danger' onclick=\"window.location.href='../pegawai/proses.php?absen=2';\" $disable_out>Absen Pulang</button></td>
