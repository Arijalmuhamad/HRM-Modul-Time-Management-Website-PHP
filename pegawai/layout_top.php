                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
							...
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Melakukan Absensi") {
										echo '<li><a href="../pegawai/absen.php" class="active">Melakukan Absensi</a></li>';
									}
									else {
										echo '<li><a href="../pegawai/absen.php">Melakukan Absensi</a></li>';
									}
							...
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Rejected") {
										echo '<li><a href="cuti_reject2.php" class="active">Ditolak</a></li>';
									}
									else {
										echo '<li><a href="cuti_reject2.php">Ditolak</a></li>';
									}
						...
						?>
						 ...
						 <!-- IZIN DINAS -->
						 <li>
							<a href="#"><i class="fa fa-envelope fa-fw"></i>&nbsp;Pengajuan Izin<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Buat Pengajuan") {
