...
if($rowscek<1){
	$sql="INSERT INTO employee(npp,nama_emp,jk_emp,telp_emp,divisi,jabatan,alamat,wfh,hak_akses,jml_cuti,password,foto_emp,active,id_adm)
		  VALUES('$npp','$nama','$jk','$telp','$divisi','$jabatan','$alamat','$wfh','$akses','$jml','$npp','$newfoto','$aktif','$id')";
