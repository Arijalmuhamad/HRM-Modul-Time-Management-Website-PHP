...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Laporan Data Izin Dinas</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
						...
						<?php
							if(isset($_GET['submit'])){
								...
								$sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp 
										AND izin.tgl_pengajuan BETWEEN '$mulai' AND '$selesai' ORDER BY izin.tgl_pengajuan DESC";
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
									...
									<tbody>
										<?php
											...
											while($data = mysqli_fetch_array($query)) {
												...
												echo '<td class="text-center text-nowrap">'. format_tanggal($data['tgl_mulai']) .'</td>';
												echo '<td class="text-center text-nowrap">'. format_tanggal($data['tgl_selesai']) .'</td>';
                                                echo '<td class="text-center text-nowrap">'. $data['tujuan'] .'</td>';
												echo '<td>'. $data['stt_izin'] .'</td>';
												echo '</tr>';
												$i++;
											}
										?>
							...
							<div class="form-group">
									<a href="laporan_cetak3.php?awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>" target="_blank" class="btn btn-warning">Cetak</a>
							</div>
							</div>
			<!-- Large modal -->
