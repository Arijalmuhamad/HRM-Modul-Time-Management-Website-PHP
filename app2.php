...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data lembur Disetujui</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp AND 
										lembur.hrd_app='1' ORDER BY lembur.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="app_cetak.php?no=<?php echo $data['no_lembur'];?>" target="_blank" class="btn btn-primary btn-xs">Cetak</a></td>
												<?php
												echo '</td>';
												echo '</tr>';												
												$i++;
