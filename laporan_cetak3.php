<?php
	...
	$sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp
			AND izin.tgl_pengajuan BETWEEN '$mulai' AND '$selesai'
			ORDER BY izin.tgl_pengajuan DESC";
	$query = mysqli_query($conn,$sql);
	// deskripsi halaman
	$pagedesc = "Laporan Data izin - Periode " . IndonesiaTgl($mulai) ." - ". IndonesiaTgl($selesai);
