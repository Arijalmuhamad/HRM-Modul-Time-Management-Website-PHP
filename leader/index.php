<?php
	...
	// approval pengajuan lembur h i
	$sqlh = "SELECT * FROM lembur WHERE leader='$id' AND stt_lembur='Menunggu Approval Leader'";
	$ressh = mysqli_query($conn, $sqlh);
	$h = mysqli_num_rows($ressh);

	$sqli = "SELECT * FROM lembur WHERE leader='$id'";
	$ressi = mysqli_query($conn, $sqli);
	$i = mysqli_num_rows($ressi);

	// approval pengajuan izin   j k
	$sqlj = "SELECT * FROM izin WHERE leader='$id' AND stt_izin='Menunggu Approval Leader'";
	$ressj = mysqli_query($conn, $sqlj);
	$j = mysqli_num_rows($ressj);

	$sqlk = "SELECT * FROM izin WHERE leader='$id'";
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								<div class="panel-body">
								<h2 align="center">Approval Pengajuan Lembur</h2>
								</div>
							</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								<div class="panel-body">
								<h2 align="center">Approval Pengajuan Izin DInas</h2>
								</div>
							</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
