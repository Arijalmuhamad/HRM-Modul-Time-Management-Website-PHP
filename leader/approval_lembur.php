...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data Approval Lembur</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp AND 
										lembur.leader='$id' AND lembur.stt_lembur='Menunggu Approval Leader' ORDER BY lembur.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  <a href="#myModal" data-toggle="modal" data-load-code="'.$data['no_lembur'].'" data-remote-target="#myModal .modal-body" class="btn btn-warning btn-xs">Detail</a>';?>
													  <a href="approval_review2.php?no=<?php echo $data['no_lembur'];?>" class="btn btn-primary btn-xs">Review</a>
