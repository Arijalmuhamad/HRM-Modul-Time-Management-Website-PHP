...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Semua Data Approval izin Dinas</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp AND 
										izin.leader='$id' ORDER BY izin.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  if($data['hrd_app']==1){
														  ?>
														  <a href="app_cetak.php?no=<?php echo $data['no_izin'];?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a>
													<?php
