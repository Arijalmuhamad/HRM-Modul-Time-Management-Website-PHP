...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data izin Dinas Menunggu Approval</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp AND izin.stt_izin !='Rejected'
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="izin_hapus.php?no=<?php echo $data['no_izin'];?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan izin No. <?php echo $data['no_izin'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
