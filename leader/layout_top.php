            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<!-- open <li> tag generated with php, see line 155-160 -->
						<a href="#"><i class="fa fa-check-square fa-fw"></i>&nbsp;Approval Lembur<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Approval Lembur") {
										echo '<li><a href="approval_lembur.php" class="active">Approval Lembur</a></li>';
									}
									else {
										echo '<li><a href="approval_lembur.php">Approval Lembur</a></li>';
									}
									if($pagedesc == "Data Approval") {
						...
						<!-- open <li> tag generated with php, see line 155-160 -->
						<a href="#"><i class="fa fa-check-square fa-fw"></i>&nbsp;Approval Izin Dinas<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Approval Izin") {
										echo '<li><a href="approval_izin.php" class="active">Approval Izin Dinas</a></li>';
									}
									else {
										echo '<li><a href="approval_izin.php">Approval Izin Dinas</a></li>';
									}
									if($pagedesc == "Data Approval") {
										echo '<li><a href="approval3.php" class="active">Semua Data Izin Dinas</a></li>';
									}
									else {
