...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data Approval izin Dinas</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp AND 
										izin.leader='$id' AND izin.stt_izin='Menunggu Approval Leader' ORDER BY izin.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  <a href="#myModal" data-toggle="modal" data-load-code="'.$data['no_izin'].'" data-remote-target="#myModal .modal-body" class="btn btn-warning btn-xs">Detail</a>';?>
													  <a href="approval_review3.php?no=<?php echo $data['no_izin'];?>" class="btn btn-primary btn-xs">Review</a>
