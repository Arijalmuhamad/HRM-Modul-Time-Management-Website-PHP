<?php
	...
	//approval cuti d e
	$sqld = "SELECT * FROM cuti WHERE spv='$id' AND stt_cuti='Menunggu Persetujuan Supervisor'";
	...
	//approval lembur k l
	$sqlk = "SELECT * FROM lembur WHERE spv='$id' AND stt_lembur='Menunggu Persetujuan Supervisor'";
	$ressk = mysqli_query($conn, $sqlk);
	$k = mysqli_num_rows($ressk);

	$sqll = "SELECT * FROM lembur WHERE spv='$id'";
	...
	//approval izin pq
	$sqlp = "SELECT * FROM izin WHERE spv='$id' AND stt_izin='Menunggu Persetujuan Supervisor'";
	$ressp = mysqli_query($conn, $sqlp);
	$p = mysqli_num_rows($ressp);

	$sqlq = "SELECT * FROM izin WHERE spv='$id'";
