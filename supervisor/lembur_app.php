            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp AND lembur.hrd_app='1'
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="app_cetak2.php?no=<?php echo $data['no_lembur'];?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
