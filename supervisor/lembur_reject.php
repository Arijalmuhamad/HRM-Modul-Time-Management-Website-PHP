...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data Lembur Ditolak</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
									...
									<tbody>
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">'. IndonesiaTgl($data['jam_mulai']) .'</td>';
												echo '<td class="text-center">'. IndonesiaTgl($data['jam_selesai']) .'</td>';
