...
echo "<div id='page-wrapper'>
        <div class='container-fluid'>
            <div class='row'>
            <div class='col-lg-12'>
            <h1 class='page-header'>Absensi Supervisor</h1>
        </div><!-- /.col-lg-12 -->
    </div><!-- /.row -->
...
echo 	"<tr>
        ...
        <td class='text-center'><button type='button' class='btn btn-warning' onclick=\"window.location.href='../supervisor/proses.php?absen=1';\" $disable_in>Absen Masuk</button></td>
        <td class='text-center'><button type='button' class='btn btn-danger' onclick=\"window.location.href='../supervisor/proses.php?absen=2';\" $disable_out>Absen Pulang</button></td>
