...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Semua Data Persetujuan lembur</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT lembur.*, employee.* FROM lembur, employee WHERE lembur.npp=employee.npp AND 
										lembur.manager='$id' ORDER BY lembur.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  if($data['hrd_app']==1){
														  ?>
														  <a href="app_cetak2.php?no=<?php echo $data['no_lembur'];?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a>
													<?php
