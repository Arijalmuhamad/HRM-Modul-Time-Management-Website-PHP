...
function valid()
{
	if(document.lembur.akhir.value < document.lembur.mulai.value){
		alert("Tanggal akhir harus lebih besar dari tanggal mulai lembur!");
		return false;
	}

	if(document.lembur.mulai.value < document.lembur.now.value){
		alert("Tanggal mulai lembur tidak valid!");
		return false;
	}
