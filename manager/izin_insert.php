...
$ress = mysqli_fetch_array($qpgw);
	...
	$sql 	= "INSERT INTO izin (no_izin, npp, tgl_pengajuan, tgl_mulai, tgl_selesai, tujuan, durasi, keterangan, stt_izin) 
				VALUES ('$id','$npp','$ajuan','$mulai','$akhir','$tujuan', '$durasi','$ket','$stt')";
