            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT izin.*, employee.* FROM izin, employee WHERE izin.npp=employee.npp ORDER BY izin.tgl_pengajuan DESC";
									...
									<tbody>
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">'. $data['tgl_mulai'] .'</td>';
												echo '<td class="text-center">'. $data['tgl_selesai'] .'</td>';
                        echo '<td class="text-center">'. $data['tujuan'] .'</td>';
												...
												echo '<td class="text-center">
													  ...
													  if($data['hrd_app']==1){
														  ?>
														  <a href="app_cetak3.php?no=<?php echo $data['no_izin'];?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a>
													<?php
